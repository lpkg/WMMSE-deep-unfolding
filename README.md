...
In the jupyter notebook "" the implementation in Python 3.6.8 of the WMMSE algorithm in [[2]] and the implementation in Python 3.6.8 and Tensorflow 1.13.1 of the unfolded WMMSE algorithm can be found.
